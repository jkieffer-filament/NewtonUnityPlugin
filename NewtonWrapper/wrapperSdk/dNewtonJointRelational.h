...
class dNewtonJointRackAndPinion : public dNewtonJoint
{
public:
	dNewtonJointRackAndPinion(dFloat gearRatio, const dVector gearPin, const dVector slidePin, void* const gearBody, void* const slideBody);
};
